...
void drawScene(GLFWwindow* window, float angle) {
	...
	Models::Teapot teapot = Models::teapot;
...
int main(void)
{
	...
	window = glfwCreateWindow(500, 500, "155632", NULL, NULL);  //Utwórz okno 500x500 o tytule "OpenGL" i kontekst OpenGL.
